<?php
	...
	$traerID = "SELECT usuario.usuarioID FROM mensajeria.usuarios WHERE usuario.Nombre= '$usuario'";
	...
	$query = "INSERT INTO mensajeria.favoritos (favID, favUserID, favPostID) VALUES ('','$idUser','$post')";
