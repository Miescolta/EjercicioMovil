			...
			<div class="contenedor">
				<section>
					<?php
						...
						$traerID = "SELECT usuario.usuarioID FROM mensajeria.usuario WHERE usuario.Nombre= '$usuarioActivo'";
						...
						$qPosts = "SELECT usuario.Nombre, publicaciones.contenido, publicaciones.postID
